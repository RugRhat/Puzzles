...
// End Cross Module References
	...
	DEFINE_FUNCTION(UPuzzleGameInstance::execLoadWinScreen)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->LoadWinScreen();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UPuzzleGameInstance::execLoadInGameMenu)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->LoadInGameMenu();
		P_NATIVE_END;
	}
	...
	void UPuzzleGameInstance::StaticRegisterNativesUPuzzleGameInstance()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "LoadInGameMenu", &UPuzzleGameInstance::execLoadInGameMenu },
			{ "LoadMenu", &UPuzzleGameInstance::execLoadMenu },
			{ "LoadWinScreen", &UPuzzleGameInstance::execLoadWinScreen },
		};
	...
	struct Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "PuzzleGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPuzzleGameInstance, nullptr, "LoadInGameMenu", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "PuzzleGameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPuzzleGameInstance, nullptr, "LoadWinScreen", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPuzzleGameInstance_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPuzzleGameInstance_LoadInGameMenu, "LoadInGameMenu" }, // 913632489
		{ &Z_Construct_UFunction_UPuzzleGameInstance_LoadMenu, "LoadMenu" }, // 2408180339
		{ &Z_Construct_UFunction_UPuzzleGameInstance_LoadWinScreen, "LoadWinScreen" }, // 4156778492
	};
#if WITH_METADATA
